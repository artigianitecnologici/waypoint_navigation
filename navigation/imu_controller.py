...
class GestureController(object):
    ...
    def init(self):
        ...
        self.angular_coefficent = rospy.get_param ('angular_coefficient', 1)
    ...
    def callback_continuos_control(self,data):
        ...
        #print self.last_acc[0],self.last_acc[1],self.last_acc[2]
        self.update()
...
def main():
    rospy.init_node('imu_controller', disable_signals=True)
